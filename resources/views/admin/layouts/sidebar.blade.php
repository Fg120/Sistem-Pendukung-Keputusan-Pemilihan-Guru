<div class="sidebar-wrapper active">
    ...
    <div class="sidebar-menu">
        <ul class="menu">
            ...
            <li class="sidebar-item">
                <a href="{{ route('home.index') }}" class="sidebar-link text-success btn btn-outline-success">
            ...
            <li class="sidebar-item {{ request()->segment(2) === 'data-penilaian' ? 'active' : '' }}">
                <a href="{{ route('admin.data_penilaian.index') }}" class="sidebar-link">
                    <i class="bi bi-bar-chart-fill"></i>
                    <span>Data Penilaian</span>
                </a>
            </li>
            <li class="sidebar-item {{ request()->segment(2) === 'hasil-akhir' ? 'active' : '' }}">
                <a href="{{ route('admin.hasil_akhir.index') }}" class="sidebar-link">
                    <i class="bi bi-bar-chart-fill"></i>
