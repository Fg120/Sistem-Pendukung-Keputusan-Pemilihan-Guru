    ...
    <main class="form-signin w-100 m-auto">
        <form method="POST" action="{{ route('login') }}">
            ...
            <div class="form-floating">
                <input type="email" name="email" class="form-control input-email" id="floatingEmail" value="{{ old('email') }}" required placeholder="">
                <label for="floatingEmail">Alamat Email</label>
            </div>
            <div class="input-group">
                <div class="form-floating">
                    <input type="password" name="password" class="form-control input-password" id="floatingPassword" required placeholder="">
            ...
            <a href="{{ route('register') }}" class="btn btn-outline-success w-100 py-2">Register</a>
        </form>
    </main>
