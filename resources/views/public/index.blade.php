            ...
            <div class="row gy-4">
                <div class="col-lg-6 order-2 order-lg-1 d-flex flex-column justify-content-center">
                    ...
                    <div class="d-flex flex-column flex-md-row" data-aos="fade-up" data-aos-delay="200">
                        @auth
                            <a href="{{ route('public.hasil.index') }}" class="btn-get-started">Lihat Hasil <i class="bi bi-arrow-right"></i></a>
                        @else
                            <a href="{{ route('login') }}" class="btn-get-started">Lihat Hasil <i class="bi bi-arrow-right"></i></a>
                        @endauth
                    </div>
                </div>
